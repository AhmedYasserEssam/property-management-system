...
public class UrgentMaintenanceFactory extends MaintenanceRequestFactory {
    public UrgentMaintenanceFactory(RequestType requestType) {
        super(requestType);
    }
    ...
    public MaintenanceRequest reconstruct(String requestID, String unitID,
        ...
        return new UrgentMaintenanceRequest(requestID, unitID, issueDescription, requestDate, status, this.requestType);
    }

    @Override
    public MaintenanceRequest createRequest(String unitID, String description) {
        return new UrgentMaintenanceRequest(unitID, description, this.requestType);
    }
}